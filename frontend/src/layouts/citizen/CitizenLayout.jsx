...
const CitizenLayout = () => {
  ...
  const navigation = [
    ...
    { name: 'Report Hazard', href: '/citizen/report', icon: '📝' },
    { name: 'My Reports', href: '/citizen/my-reports', icon: '📊' },
    { name: 'Alerts', href: '/citizen/alerts', icon: '🚨' },
  ];

  const isActiveLink = (href) => {
    return location.pathname === href || (href === '/citizen/dashboard' && location.pathname === '/citizen');
  };
  ...
  return (
    <div className="h-screen flex bg-gray-50">
      ...
      <div className={`fixed inset-y-0 left-0 z-30 w-64 bg-white shadow-lg transform transition-transform duration-200 ease-in-out lg:translate-x-0 lg:static lg:inset-0 ${
        ...
        <div className="flex items-center justify-center h-16 px-4 bg-ocean-600">
          <h1 className="text-xl font-bold text-white">🌊 Samudra Alert</h1>
        </div>
        ...
        <div className="absolute bottom-0 left-0 right-0 p-4 border-t border-gray-200">
          <div className="flex items-center mb-4">
            <div className="w-8 h-8 bg-ocean-600 rounded-full flex items-center justify-center text-white text-sm font-semibold">
